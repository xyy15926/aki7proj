...
if __name__ == "__main__":
    ...
    from suitbear.cashflow import confflat, confagg, conftrans
    reload(ex2df)
    reload(ex4df)
    reload(exenv)
    reload(exoptim)
...
from suitbear.cashflow.confflat import df_flat_confs
from suitbear.cashflow.conftrans import df_trans_confs, TRANS_ENV
from suitbear.cashflow.confagg import df_agg_confs
