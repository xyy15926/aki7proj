...
if __name__ == "__main__":
    ...
    from ringbear import metrics, sortable
    from modsbear.spanner import dflog
    from suitbear.dirt import flows
    reload(metrics)
    reload(sortable)
    reload(dflog)
    reload(flows)
...
from modsbear.spanner.dflog import (
    RC_NAME, MA_NAME, VA_NAME,
    PCORR_NAME, ROWN_NAME,
    NUM_NAME, CAT_NAME,
    INIT_STATE
)
from suitbear.dirt.flows import DataProc
